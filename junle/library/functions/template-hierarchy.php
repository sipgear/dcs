...
add_filter( 'date_template', 'supreme_date_template' );
...
add_filter( 'tag_template', 'supreme_taxonomy_template' );
add_filter( 'category_template', 'supreme_taxonomy_template' );
add_filter( 'taxonomy_template', 'supreme_taxonomy_template' );
 ...
 */
function supreme_date_template( $template ) {
	$templates = array();
 ...
 * @return string Full path to file.
 */
function supreme_taxonomy_template( $template ) {
